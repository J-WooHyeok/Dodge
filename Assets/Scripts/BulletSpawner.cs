...
public class BulletSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawnRate = Random.Range(spawnRateMin, spawnRateMax);   //탄알 생성 간격을 ~~사이에서 랜덤으로 지정
    ...
    void Update()
    {
        ...
        if(timeAfterSpawn >= spawnRate)     //최근 생성 시점에서부터 누적된 시간이 생성 주기보다 크거나 같다면
        {
            ...
            spawnRate = Random.Range(spawnRateMin, spawnRateMax);   //다음 생성 간격을 Min과 Max 사이에서 랜덤으로 지정
        }
    }
}
